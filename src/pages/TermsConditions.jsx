      ...
      <div className="flex flex-col justify-center items-center font-sans ">
        <div className="text-center mt-10 h-full w-[54rem]  flex flex-col items-center justify-center">
          ...
          <p className=" text-center">
            ...
            Narendra Modi in public platforms. By accessing or using the
            ...
            the website. Ownership of Data: The data displayed on the website is
            sourced from the internet and is not owned by us. We do not claim
            ownership of the content displayed. If you believe that any content
            infringes on your legal rights or copyright, please contact us
            immediately, and we will take the necessary actions to address the
            issue. Legal Compliance: We are committed to complying with all
            applicable laws and regulations. If any legal or copyright issues
            arise regarding the content displayed on the website, we will
